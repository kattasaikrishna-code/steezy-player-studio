...
export const SectionsSidebar: React.FC<SectionsSidebarProps> = ({
  ...
  return (
    <div className="w-80 bg-card border-l border-border overflow-hidden flex flex-col">
      ...
      <button
        className="p-3 absolute top-3 right-3 bg-primary/20 rounded-md text-primary hover:bg-primary/30 transition-colors"
        ...
        {sections.map((section, index) => {
          ...
          const isCurrent =
            ...
            (index === sections.length - 1 ||
              currentTime < sections[index + 1].startTime);
