...
const demoSources = {
  front: 'https://cdn.plyr.io/static/demo/View_From_A_Blue_Moon_Trailer-720p.mp4',
  back: 'https://cdn.plyr.io/static/demo/View_From_A_Blue_Moon_Trailer-720p.mp4',
};
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Learn dance with our interactive video player featuring loop sections, mirror mode, and camera preview." />
      </Helmet>
